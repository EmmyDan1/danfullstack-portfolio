...
const projects: Projects[] = [
  {
    ...
    quote: "Built to streamline last-mile delivery ops with live route mapping and driver assignment.",
  ...
  },
  {
    ...
    quote: "A full thrift store experience online — from admin uploads to WhatsApp-powered checkout.",
